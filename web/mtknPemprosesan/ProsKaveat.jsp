<%-- 
    Document   : ProsKaveat
    Created on : Mar 18, 2019, 10:16:17 AM
    Author     : shahr
--%>
...
<div class="row">
    <div class="col-lg-12"> 
        ...
        <s:if test="layout.equals(\"frame\")">
            <s:set name="urlAkaun">2FrameProsKaveat</s:set>        
        </s:if>
        <s:else>
            <s:set name="urlAkaun">ProsKaveatLink2</s:set>        
        </s:else>

        <s:form cssClass="form-horizontal " action="save%{#urlAkaun}" namespace="tanya">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Proses Kaveat</h3>
                </div>
                <div class="panel-body" id="panel" >
                    ...
                    <div class="form-group"> 
                        ...
                        <div class="btn-group pull-right col-lg-offset-10">
                            ...
                            <%--button class="btn btn-primary dropdown-toggle" data-toggle="dropdown">Cetak Bil<i class="fa fa-angle-down"></i>
                            </button--%>
