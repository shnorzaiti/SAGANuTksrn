<%-- 
    Document   : dialogJbtnHg
    Created on : Mar 23, 2015, 11:42:06 AM
    Author     : farisazri
--%>
...
<html>
    ...
    <script>
        ...
        <%--alert(data1+":"+data2+":"+data3);--%>
            window.parent.$('#JbtnHg').val(data1);//kod
            window.parent.$("#modalJbtnHg").modal('hide');
                ...
                <section class="panel">
                    <div class="panel-body">
                        <div class="adv-table editable-table col-sm-12">
                            <s:form id="KodJabatanHgForm" cssClass="form-horizontal" action="popJbtnHg" method="post">
                        ...
                        <display:table id="senaraiKodTable" name="JbtnPopList" pagesize="${pageSizeSelected}" cellpadding="5px;"  
                            ...
                            <display:column  title="Kod Jabatan" style="width:10%; padding-right:10px !important; text-align: right;"> 
                                <s:a href="#" onclick="passData('%{#attr.senaraiKodTable.JabJbkod}')"><s:property value="%{#attr.senaraiKodTable.JabJbkod}"/></s:a>
                            </display:column>
