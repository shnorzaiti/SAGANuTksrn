<%-- 
    Document   : PenyataTunggakCBK
    Created on : Aug 11, 2016, 11:24:36 AM
    Author     : farisazri
--%>
    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" id="panel">
                <s:form action="cetakPenyataTunggakCBKLink2" method="post" cssClass="form-horizontal">
...
<div class="modal fade" id="modalCetak" tabindex="-1" role="dialog"  aria-labelledby="modalCetakLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" style="width: 100%; height: 100%; padding: 0">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="modalCetakLabel">Penyata Tunggakan CBK - Mengikut Jabatan</h4>
            </div>
