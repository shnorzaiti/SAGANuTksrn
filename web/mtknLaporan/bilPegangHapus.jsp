<%-- 
    Document   : bilPegangHapus
    Created on : Mar 31, 2015, 11:43:48 AM
    Author     : ainyrusly
--%>
    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" id="panel">
                <s:form cssClass="form-horizontal bucket-form" action="cetakBilPegangHapusLink2" method="post">
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">                                                
                            ...
                            <div class="form-group">
                                ...
                                <span class="input-group-addon">Hingga</span></i></span>
                                        <span class="input-group-addon">RM</span>
...
<div class="modal fade" id="modalCetak" tabindex="-1" role="dialog"  aria-labelledby="modalCetakLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" style="width: 100%; height: 100%; padding: 0">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="modalCetakLabel">Bil Pegangan Yang Di Hapus</h4>
            </div>
