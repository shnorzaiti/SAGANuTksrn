<%-- 
    Document   : BilPeganganHapus
    Created on : Jul 27, 2016, 1:04:03 AM
    Author     : ShahRizal
--%>
    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" id="panel">
                <s:form action="cetakBilCukaiTaksirLink2" method="post" cssClass="form-horizontal">
                    </s:form>
            </div>
        </div>
    </div>
    ...
    <div class="modal-dialog modal-lg" style="width: 100%; height: 100%; padding: 0">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title" id="modalCetakLabel">Bil Pegangan Yang Dihapus</h4>
            </div>
