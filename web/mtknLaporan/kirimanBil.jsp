<%-- 
    Document   : kirimanBil
    Created on : Mar 30, 2015, 12:23:56 PM
    Author     : ainyrusly
--%>
    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" id="panel">
                <s:form cssClass="form-horizontal bucket-form" action="cetakKirimanBilLink2" method="post">
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">                                                
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Nilai Setem :</label>
                                <div class="col-sm-3">
                                    <div class="input-group ">
            ...
            <div class="modal fade" id="modalCetak" tabindex="-1" role="dialog"  aria-labelledby="modalCetakLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" style="width: 100%; height: 100%; padding: 0">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            <h4 class="modal-title" id="modalCetakLabel">Kiriman Bil</h4>
                        </div>
