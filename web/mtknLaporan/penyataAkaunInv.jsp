<%-- 
    Document   : penyataAkaunInv
    Created on : Mar 26, 2015, 12:50:17 PM
    Author     : ainyrusly
--%>
    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" id="panel">
                <s:form cssClass="form-horizontal bucket-form" action="cetakPenyataAkaunInvLink2" method="post">
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Pilihan :</label>
                        <div class="col-sm-10">
                            <s:if test="param1.equals(\"0\")">
                                <label class="">
                                    <input type="radio" name="param1" id="pilihan" value="0" onclick="carianBy()" checked="true"> Tahun Semasa
                                </label>                                
                            </s:if>
                            <s:else>
                                <label class="">
                                    <input type="radio" name="param1" id="pilihan" value="0" onclick="carianBy()" > Tahun Semasa
                                </label>                                
                            </s:else>
                            <s:if test="param1.equals(\"1\")">
                                <label class="">
                                    <input type="radio" name="param1" id="pilihan" value="1" onclick="carianBy()" checked="true"> Tahun Lepas
                                </label>                                
                            </s:if>
                            <s:else>
                                <label class="">
                                    <input type="radio" name="param1" id="pilihan" value="1" onclick="carianBy()"> Tahun Lepas
                                </label>                                
                            </s:else>
                            <s:if test="param1.equals(\"2\")">
                                <label class="">
                                    <input type="radio" name="param1" id="pilihan" value="2" onclick="carianBy()" checked="true"> 2 Tahun Lepas
                                </label>
                            </s:if>
                            <s:else>
                                <label class="">
                                    <input type="radio" name="param1" id="pilihan" value="2" onclick="carianBy()"> 2 Tahun Lepas
                                </label>
                            </s:else>
                            <s:if test="param1.equals(\"3\")">
                                <label class="">
                                    <input type="radio" name="param1" id="pilihan" value="3" onclick="carianBy()" checked="true"> 3 Tahun Lepas
                                </label>
                            </s:if>
                            <s:else>
                                <label class="">
                                    <input type="radio" name="param1" id="pilihan" value="3" onclick="carianBy()"> 3 Tahun Lepas
                                </label>                                
                            </s:else>
                            <s:if test="param1.equals(\"4\")">
                                <label class="">
                                    <input type="radio" name="param1" id="pilihan" value="4" onclick="carianBy()" checked="true"> 4 Tahun Lepas
                                </label>                                
                            </s:if>
                            <s:else>
                                <label class="">
                                    <input type="radio" name="param1" id="pilihan" value="4" onclick="carianBy()"> 4 Tahun Lepas
                                </label>
                            </s:else>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">                                                
                            <div class="input-group ">
                                ...
                                <s:textfield id="AkaunDr" name="param2" cssClass="form-control input-sm"/> 
                                ...
                                <s:textfield id="AkaunHg" name="param3" cssClass="form-control input-sm"/> 
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">                                                
                                    <div class="input-group ">
                                        <span class="input-group-addon">Dari</span>
                                <s:textfield id="JlkodDr" name="param4" cssClass="form-control input-sm"/> 
                                ...
                                <span class="input-group-addon">Hingga</span>
                                <s:textfield id="JlkodHg" name="param5" cssClass="form-control input-sm"/> 
            ...
            <div class="modal fade" id="modalCetak" tabindex="-1" role="dialog"  aria-labelledby="modalCetakLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" style="width: 100%; height: 100%; padding: 0">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            <h4 class="modal-title" id="modalCetakLabel">Penyata Akaun Individu - Tahun Semasa</h4>
                        </div>
