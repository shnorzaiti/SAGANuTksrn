<%-- 
    Document   : AnalisaBayarPegangan
    Created on : Aug 10, 2016, 2:58:21 PM
    Author     : farisazri
--%>
    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" id="panel">
                <s:form cssClass="form-horizontal bucket-form" action="cetakAnalisaBayarPeganganLink2" method="post">
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Pilihan :</label>
                        <div class="col-sm-9">
                            <s:if test="param7.equals(\"1\")">
                            <label class="">
                                <input type="radio" name="param7" id="pilihan" value="1" onclick="carianBy()" checked="true"> Tahun Semasa
                            </label>                                
                            </s:if>
                            <s:else>
                            <label class="">
                                <input type="radio" name="param7" id="pilihan" value="1" onclick="carianBy()" > Tahun Semasa
                            </label>            
                            </s:else>
                            <s:if test="param7.equals(\"2\")">
                            <label class="">
                                <input type="radio" name="param7" id="pilihan" value="2" onclick="carianBy()" checked="true"> Tahun Lepas
                            </label>       
                            </s:if>
                            <s:else>
                            <label class="">
                                <input type="radio" name="param7" id="pilihan" value="2" onclick="carianBy()" > Tahun Lepas
                            </label>                                       
                            </s:else>
                        </div>
                    </div>
                        ...
                        <div class="col-sm-7">                                                
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-7">
                                    <div class="input-group ">      
                                        <span class="input-group-addon">Dari</span>
                                    <s:textfield id="trikhDr" name="param5" cssClass="form-control input-sm datepicker"/>    
                                        <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                <span class="input-group-addon">Hingga</span>
                                    <s:textfield id="trikhHg" name="param6" cssClass="form-control input-sm datepicker"/>     
                                <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                            </div>
    ...
    <div class="modal fade" id="modalCetak" tabindex="-1" role="dialog"  aria-labelledby="modalCetakLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" style="width: 100%; height: 100%; padding: 0">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title" id="modalCetakLabel">Analisa Bayaran Mengikut Tarikh - Pegangan</h4>
                </div>
