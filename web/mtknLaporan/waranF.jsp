<%-- 
    Document   : waranF
    Created on : Mar 26, 2015, 12:39:14 PM
    Author     : farisazri
--%>
    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" id="panel">
                <s:form cssClass="form-horizontal bucket-form" action="cetakWaranFLink2" method="post">

                    <div class="form-group">
                        <label class="col-sm-2 control-label">Pilihan :</label>
                        <div class="col-sm-9">
                            <s:if test="reportName.equals(\"httpp3_a4\")">
                                <label class="">
                                    <input type="radio" name="reportName" id="pilihan" value="httpp3_a4" onclick="carianBy()" checked="true"> Cetakan Depan
                                </label>       
                            </s:if>
                            <s:else>
                                <label class="">
                                    <input type="radio" name="reportName" id="pilihan" value="httpp3_a4" onclick="carianBy()" > Cetakan Depan
                                </label>                                
                            </s:else>
                            <s:if test="reportName.equals(\"httpp3_a4b\")">
                                <label class="">
                                    <input type="radio" name="reportName" id="pilihan" value="httpp3_a4b" onclick="carianBy()" checked="true"> Cetakan Belakang
                                </label>      
                            </s:if>
                            <s:else>
                                <label class="">
                                    <input type="radio" name="reportName" id="pilihan" value="httpp3_a4b" onclick="carianBy()" > Cetakan Belakang
                                </label>      
                            </s:else>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Akaun:</label>
                        <div class="col-sm-7">                                                
...
<div class="modal fade" id="modalCetak" tabindex="-1" role="dialog"  aria-labelledby="modalCetakLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" style="width: 100%; height: 100%; padding: 0">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="modalCetakLabel">Waran F</h4>
            </div>
