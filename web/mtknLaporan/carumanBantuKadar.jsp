    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-heading">
                ...
                <h3  class="panel-title">Bil Sumbangan Membantu Kadar</h3>
            </div>
            <div class="panel-body" id="panel">
                <s:form action="cetakCarumanBantuKadarLink2" method="post" cssClass="form-horizontal">
...
<div class="modal fade" id="modalCetak" tabindex="-1" role="dialog"  aria-labelledby="modalCetakLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" style="width: 100%; height: 100%; padding: 0">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="modalCetakLabel">Bil Sumbangan Membantu Kadar</h4>
            </div>
