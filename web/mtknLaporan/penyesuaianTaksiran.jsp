<%-- 
    Document   : penyesuaianTaksiran
    Created on : Mar 4, 2019, 10:39:18 AM
    Author     : shahr
--%>
    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" id="panel">
                <s:form cssClass="form-horizontal bucket-form" action="savePenyesuaianLink2" method="post">
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Pilihan Tahun :</label>
                        <div class="col-sm-9">
                            <label class="">
                                <input type="radio" name="tahun" id="pilihan" value="TS" checked="true"> Tahun Semasa   
                            </label> &nbsp; &nbsp;   
                            <label class="">
                                <input type="radio" name="tahun" id="pilihan" value="TL"> Tahun Lalu
                            </label>                            
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Pilihan Laporan :</label>
                        <div class="col-sm-10">
                            <label class="">
                                <input type="radio" name="reportName"  value="httl30" onclick="carianBy()" checked="true"> Terperinci - Pegangan
                            </label> &nbsp; &nbsp;                                        
                            <label class="">
                                <input type="radio" name="reportName"  value="htl30jl" onclick="carianBy()"> Ringkasan - Jalan/Taman/Kampung
                            </label>
                        </div>
                    </div>  
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">                                                
                            ...
                            <div class="form-group">
                                ...
                                <s:textfield id="AmaunDr" name="param6" cssClass="form-control input-sm"/>
                                <span class="input-group-addon">Hingga</span>
                                <span class="input-group-addon">RM</span>
                                <s:textfield id="AmaunHg" name="param7" cssClass="form-control input-sm"/>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">                                                
                            <div class="input-group ">
                                ...
                                <s:textfield id="AmaunDr" name="param8" cssClass="form-control has-feedback-right input-sm datepicker"/>
                                <span class="input-group-addon">Hingga</span>
                                <span class="fa fa-calendar form-control-feedback right" aria-hidden="true"></span>
                                <s:textfield id="AmaunHg" name="param9" cssClass="form-control has-feedback-right input-sm datepicker"/>
                            </div>
                        </div>
                    </div>    
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <s:select id="stat" name="param5" headerKey="" list="statusList" listKey="LookupCode" headerValue="~~~PILIH STATUS~~~" listValue="LookupDesc" cssClass="form-control input-sm" title="Status"/>
                        </div>
                    </div>
            ...
            <div class="modal fade" id="modalCetak" tabindex="-1" role="dialog"  aria-labelledby="modalCetakLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" style="width: 100%; height: 100%; padding: 0">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            <h4 class="modal-title" id="modalCetakLabel">Laporan Penyesuaian Taksiran</h4>
                        </div>
