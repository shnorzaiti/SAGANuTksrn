<%-- 
    Document   : notisEBilHari
    Created on : Apr 10, 2015, 11:00:43 AM
    Author     : farisazri
--%>
    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" id="panel">
                <s:form cssClass="form-horizontal bucket-form" action="cetakNotisEBilHariLink2" method="post">
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">                                                
                            ...
                            <div class="form-group">
                                <label class="col-sm-2 control-label">Bil Hari:</label>
                                <div class="col-sm-3">                                      
                                    <div class="input-group ">
                                <s:textfield id="bilHari" name="param5" cssClass="form-control input-sm"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-7">                                                
                            <div class="input-group ">
                                <span class="input-group-addon">Dari</span>
                                <s:textfield id="AbjadDr" name="param6" cssClass="form-control input-sm"/>
                                <span class="input-group-addon">Hingga</span>
                                <s:textfield id="AbjadHg" name="param7" cssClass="form-control input-sm"/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
...
<div class="modal fade" id="modalCetak" tabindex="-1" role="dialog"  aria-labelledby="modalCetakLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" style="width: 100%; height: 100%; padding: 0">
        <div class="modal-content">
            <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                <h4 class="modal-title" id="modalCetakLabel">Senarai Notis E Lebih Dari (Bil Hari)</h4>
            </div>
