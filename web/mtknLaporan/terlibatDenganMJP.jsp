<%-- 
    Document   : terlibatDenganMJP
    Created on : Mar 20, 2015, 2:43:03 PM
    Author     : farisazri
--%>
    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" id="panel">
                <s:form cssClass="form-horizontal bucket-form" action="cetakPeganganTerMJPLink2" method="post">
                ...
                <div class="modal-dialog modal-lg" style="width: 100%; height: 100%; padding: 0">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="modalCetakLabel">Pegangan Terlibat Dengan MJP</h4>
                        </div>
