<%-- 
    Document   : statPegHutang
    Created on : Mar 26, 2015, 9:37:48 AM
    Author     : ainyrusly
--%>
    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" id="panel">
                <s:form cssClass="form-horizontal bucket-form" action="cetakStatPegHutangLink2" method="post">
                    <%--div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <label class="">
                                <input type="radio" name="param3" id="pilihan" value="3" onclick="carianBy()"> 2 Tahun Lepas
                            </label>
                            <label class="">
                                <input type="radio" name="param3" id="pilihan" value="4" onclick="carianBy()"> 3 Tahun Lepas
                            </label>
                ...
                <div class="modal-dialog modal-lg" style="width: 100%; height: 100%; padding: 0">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="modalCetakLabel">Statistik Pegangan Brhutang - Pegangan</h4>
                        </div>
