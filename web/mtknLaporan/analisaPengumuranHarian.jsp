<%-- 
    Document   : analisaPengumuranHarian
    Created on : Mar 30, 2015, 3:47:11 PM
    Author     : ainyrusly
--%>
    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" id="panel">
                <s:form cssClass="form-horizontal bucket-form" action="cetakAnalisaPengumuranHarianLink2" method="post">
                    <div class="form-group">
                        <label class="col-sm-2 control-label">Pilihan :</label>
                        <div class="col-sm-10">
                            <s:if test="param5.equals(\"1\")">
                            <label class="">
                                <input type="radio" name="param5" id="pilihan" value="1" onclick="carianBy()" checked="true"> Tahun Semasa
                            </label>
                            </s:if>
                            <s:else>
                            <label class="">
                                <input type="radio" name="param5" id="pilihan" value="1" onclick="carianBy()" > Tahun Semasa
                            </label>
                            </s:else>
                            <s:if test="param5.equals(\"2\")">
                            <label class="">
                                <input type="radio" name="param5" id="pilihan" value="2" onclick="carianBy()" checked="true"> Tahun Lepas
                            </label>
                            </s:if>
                            <s:else>
                            <label class="">
                                <input type="radio" name="param5" id="pilihan" value="2" onclick="carianBy()"> Tahun Lepas
                            </label>                                
                            </s:else>
            ...
            <div class="modal fade" id="modalCetak" tabindex="-1" role="dialog"  aria-labelledby="modalCetakLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg" style="width: 100%; height: 100%; padding: 0">
                    <div class="modal-content">
                        <div class="modal-header">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                            <h4 class="modal-title" id="modalCetakLabel">Analisa Pengumuran Harian</h4>
                        </div>
