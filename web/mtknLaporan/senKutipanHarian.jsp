<%-- 
    Document   : senKutipanHarian
    Created on : Mar 25, 2015, 4:08:05 PM
    Author     : ainyrusly
--%>
    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" id="panel">
                <s:form cssClass="form-horizontal bucket-form" action="cetakSenKutipanHarianLink2" method="post">
                ...
                <div class="modal-dialog modal-lg" style="width: 100%; height: 100%; padding: 0">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title" id="modalCetakLabel">Senarai Kutipan Harian</h4>
                        </div>
