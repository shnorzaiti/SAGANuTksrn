  ...
  $.fn.persistentPanel = function(userOptions) {
    ...
    switch (settings.openDirection) {
        ...
        case 'up':
          ...
          settings.togglerContents.closed = settings.togglerContents.closed || '&#xf077;'; // ▲

          // Open
          settings.animations.open = settings.animations.open || toggles.verticalOpen;
          settings.togglerContents.open = settings.togglerContents.open || '&#xf078;'; // ▼ chevron-down bootstrap
          //
          break;
        case 'down':
        default:
          ...
          // Open
          settings.animations.open = settings.animations.open || toggles.verticalOpen;
          settings.togglerContents.open = settings.togglerContents.open || '&#xf077;'; // ▲ chevron-up bootstrap
          break;
