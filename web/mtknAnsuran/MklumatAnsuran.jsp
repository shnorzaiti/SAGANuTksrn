        ...
        <s:if test="!HVnduk4.pegAkaun.equals(\"\") && HVnduk4.pegStatf.equals(\"AKTIF\") && (@java.lang.Double@parseDouble(pnyataAkaun.baki.replaceAll(\",\", \"\")) > 0)">
            <div class="x_content">
                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                    <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                        <li class="active">
                            <s:a href="#">Automatik</s:a>
                            </li>
                            <li>
                            <s:a href="ManualLink2?HVnduk4.pegAkaun=%{HVnduk4.pegAkaun}">Manual</s:a>
                            </li>
                        </ul>
                            ...
                            <div role="tabpanel" class="tab-pane fade active in" id="tab_content3" aria-labelledby="home-tab"> 
                                <div class="panel panel-default">
                                    <div class="panel-heading">
                                        ...
                                        <h3 class="panel-title">permohonan ansuran (Automatik)</h3>
                                    </div>
                                    ...
                                    <s:form id="formAnsuran" cssClass="form-horizontal bucket-form" namespace="/ansuran" action="janaAnsuranLink2">
                                                ...
                                                <s:else>
                                                    <s:if test="bilAns.in1Stang != null">  
                                                        <s:if test="bilAns.in1Stang.equals(\"Y\")">                                    
                                                            <s:checkbox id="majlis" name="bilAns.in1Stang" value="true" cssClass="form-control"  />
                                                        </s:if>
                                                        <s:else>
                                                            <s:checkbox id="majlis" name="bilAns.in1Stang" cssClass="form-control"/>
                                                        </s:else>                              
                                                    </s:if>
                                                    <s:else>  
                                        ...
                                        <s:if test="!stsUpd.equals(\"Y\")"> 
                                            <div id="butang" class="operation-button">
                                                <button type="submit" class="jana confirm" data-msg="<s:text name="mesej.simpan"/>" formId="formAnsuran"></button>
