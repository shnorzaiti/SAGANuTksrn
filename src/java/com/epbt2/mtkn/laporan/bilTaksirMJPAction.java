...
public class bilTaksirMJPAction extends ActionSupport implements Preparable {
    ...
    public String cetak() {
        ...
        setCetakLink(req.getContextPath() + "/report/cetak?reportName=httpp6" + "&param1=" + param1 + "&param2=");
        return SUCCESS;
    }
