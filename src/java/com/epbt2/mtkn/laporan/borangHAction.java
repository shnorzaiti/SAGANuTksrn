...
public class borangHAction extends ActionSupport implements Preparable {
    ...
    public String cetak() {
        ...
        setCetakLink(req.getContextPath() + "/report/cetak?reportName=http74_a4" + "&param1=" + param1 + "&param2=" + param2 + "&param3=" + param3);
        return SUCCESS;
    }
