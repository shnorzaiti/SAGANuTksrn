...
public class statPegHutangAction extends ActionSupport implements Preparable {
    ...
    public String cetak() {
        ...
        setCetakLink(req.getContextPath() + "/report/cetak?reportName=httl25a" + "&param1=" + param1 + "&param2=" + param2 + "&param3=" + param3);
        return SUCCESS;
    }
