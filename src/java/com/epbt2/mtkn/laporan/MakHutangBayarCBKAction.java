...
public class MakHutangBayarCBKAction extends ActionSupport implements Preparable {
    ...
    public String cetak() {
        ...
        setCetakLink(req.getContextPath() + "/report/cetak?reportName=httl18" + "&param1=" + param1 + "&param2=" + param2);
        return SUCCESS;
    }
