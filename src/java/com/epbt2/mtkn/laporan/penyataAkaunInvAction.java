...
public class penyataAkaunInvAction extends ActionSupport implements Preparable {
    ...
    public String cetak() {
        ...
        setCetakLink(req.getContextPath() + "/report/cetak?reportName=httl11lj" + "&param1=" + param1 + "&param2=" + param2 + "&param3=" + param3 + "&param4=" + param4 + "&param5=" + param5);
        return SUCCESS;
    }
