...
public class kirimanBilAction extends ActionSupport implements Preparable {
    ...
    private String[] valSetem = new String[1];
    ...
    public String cetak() {
        ...
        setCetakLink(req.getContextPath() + "/report/cetak?reportName=htts29" + "&param1=" + param1 + "&param2=" + param2 + "&param3=" + param3 + "&param4=" + param4 + "&param5=" + param5);
        return SUCCESS;
    }
    ...
    public void prepare() throws Exception {
        ...
        try {
            ...
            /*valSetem= valHelper.minMaxValue(conn, "SETEM", "MTKN");
    ...
    public String[] getValSetem() {
        return valSetem;
    }

    public void setValSetem(String[] valSetem) {
        this.valSetem = valSetem;
    }
