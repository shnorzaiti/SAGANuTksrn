...
public class makHutangSemasaPeganganAction extends ActionSupport implements Preparable {
    ...
    public String cetak() {
        ...
        setCetakLink(req.getContextPath() + "/report/cetak?reportName=httl23" + "&param1=" + param1 + "&param2=" + param2 + "&param3=" + param3 + "&param4=" + param4);
        return SUCCESS;
    }
