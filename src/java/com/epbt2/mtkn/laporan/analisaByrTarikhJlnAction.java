...
public class analisaByrTarikhJlnAction extends ActionSupport implements Preparable {
    ...
    public String cetak() {
        ...
        setCetakLink(req.getContextPath() + "/report/cetak?reportName=httl15" + "&param1=" + param1 + "&param2=" + param2 + "&param3=" + param3);
        return SUCCESS;
    }
