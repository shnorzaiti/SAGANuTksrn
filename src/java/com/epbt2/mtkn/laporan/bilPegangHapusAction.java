...
public class bilPegangHapusAction extends ActionSupport implements Preparable {
    ...
    private String[] valAkaun_H = new String[2];
    ...
    public String cetak() {
        ...
        setCetakLink(req.getContextPath() + "/report/cetak?reportName=httpp9&param1=" + param1 + "&param2=" + param2 + "&param3=" + param3 + "&param4=" + param4 + "&param5=" + param5 + "&param6=" + param6);
        return SUCCESS;
    }
    ...
    public void prepare() throws Exception {
        ...
        try {
            valAkaun_H = valHelper.minMaxValue(conn, "AKAUN_H", "MTKN");
    ...
    public String[] getValAkaun_H() {
        return valAkaun_H;
    }

    public void setValAkaun_H(String[] valAkaun_H) {
        this.valAkaun_H = valAkaun_H;
    }
