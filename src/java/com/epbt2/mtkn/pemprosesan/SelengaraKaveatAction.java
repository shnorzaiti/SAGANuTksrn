 ...
 * @author shahr
 */
public class SelengaraKaveatAction extends ActionSupport implements Preparable {
    ...
    public String save() throws Exception {
        ...
        try {
            ...
            addActionMessage(getText("Selenggara Kaveat telah berjaya..", msgArgs));

            selenggaraKaveat(conn, PelMklumatPgangan.getPegAkaun());
    ...
    public void selenggaraKaveat(Connection conn, String pegAkaun) throws SQLException {

        String sql = "{ call mtkn.sp_mtkn.selenggara_kaviat('" + pegAkaun + "') } ";
    ...
    public HVnduk4DaoExt getPelMklumatPganganDaoExt() {
        return PelMklumatPganganDaoExt;
    }

    public void setPelMklumatPganganDaoExt(HVnduk4DaoExt PelMklumatPganganDaoExt) {
        this.PelMklumatPganganDaoExt = PelMklumatPganganDaoExt;
    }
