...
/**
 * HVpjln Data Access Object (DAO). This class contains all database handling
 * that is needed to permanently store and retrieve HVpjln object instances.
 */
/**
...
public class HVpjlnDao {
     ...
     * method in it!
     */
    public HVpjln createValueObject() {
        return new HVpjln();
    }
     ...
     */
    public HVpjln getObject(Connection conn, String JLkod) throws NotFoundException, SQLException {

        HVpjln valueObject = createValueObject();
        valueObject.setJLkod(JLkod);
     ...
     */
    public void load(Connection conn, HVpjln valueObject) throws NotFoundException, SQLException {
        ...
        String sql = "SELECT * FROM MTKN.HVPJLN WHERE (JLKOD = ? ) ";
        PreparedStatement stmt = null;

        try {
            stmt = conn.prepareStatement(sql);
            stmt.setString(1, valueObject.getJLkod());
    ...
    public List loadAll(Connection conn) throws SQLException {
        ...
        String sql = "SELECT * FROM MTKN.HVPJLN ORDER BY JLKOD ASC ";
     ...
     */
    public synchronized void create(Connection conn, HVpjln valueObject) throws SQLException {
        ...
        try {
            sql = "INSERT INTO MTKN.HVPJLN ( JLKOD, JNAMA, AKTIF, "
                    + "BATAL) VALUES (?, ?, ?, ?) ";
            stmt = conn.prepareStatement(sql);

            stmt.setString(1, valueObject.getJLkod());
            stmt.setString(2, valueObject.getJNama());
            stmt.setString(3, valueObject.getAKtif());
            stmt.setString(4, valueObject.getBAtal());
     ...
     */
    public void save(Connection conn, HVpjln valueObject)
            throws NotFoundException, SQLException {

        String sql = "UPDATE MTKN.HVPJLN SET JNAMA = ?, AKTIF = ?, BATAL = ? WHERE (JLKOD = ? ) ";
        PreparedStatement stmt = null;

        try {
            stmt = conn.prepareStatement(sql);
            stmt.setString(1, valueObject.getJNama());
            stmt.setString(2, valueObject.getAKtif());
            stmt.setString(3, valueObject.getBAtal());

            stmt.setString(4, valueObject.getJLkod());
     ...
     */
    public void delete(Connection conn, HVpjln valueObject)
            throws NotFoundException, SQLException {
        ...
        String sql = "DELETE FROM MTKN.HVPJLN WHERE (JLKOD = ? ) ";
        PreparedStatement stmt = null;
    ...
    public void deleteAll(Connection conn) throws SQLException {
        ...
        String sql = "DELETE FROM MTKN.HVPJLN";
        PreparedStatement stmt = null;
    ...
    public int countAll(Connection conn) throws SQLException {
        ...
        String sql = "SELECT count(*) FROM MTKN.HVPJLN";
        PreparedStatement stmt = null;
        ResultSet result = null;
        int allRows = 0;
     ...
     */
    public List searchMatching(Connection conn, HVpjln valueObject) throws SQLException {

        List searchResults;

        boolean first = true;
        StringBuffer sql = new StringBuffer("SELECT * FROM MTKN.HVPJLN WHERE 1=1 ");

        if (!valueObject.getJLkod().equals("") || !valueObject.getJNama().equals("")) {
            sql.append("AND (");

            if (!valueObject.getJLkod().equals("")) {
                if (first) {
                    first = false;
                }
                sql.append("JLKOD LIKE ").append(valueObject.getJLkod()).append(" ");
            }

            if (!valueObject.getJNama().equals("")) {
                if (first) {
                    first = false;
                }
                if (!valueObject.getJLkod().equals("")) {
                ...
                sql.append("JNAMA LIKE '").append(valueObject.getJNama()).append("' ");
            }

            /*  if (valueObject.getAKtif() != null) {
             if (first) { first = false; }
             sql.append("AND AKTIF LIKE '").append(valueObject.getAKtif()).append("%' ");
             }

             if (valueObject.getBAtal() != null) {
             if (first) { first = false; }
             sql.append("AND BATAL LIKE '").append(valueObject.getBAtal()).append("' ");
             }*/
            sql.append(") ");
        }

        sql.append("ORDER BY JLKOD ASC ");
     ...
     */
    protected void singleQuery(Connection conn, PreparedStatement stmt, HVpjln valueObject)
            throws NotFoundException, SQLException {
        ...
        try {
            ...
            if (result.next()) {
                ...
                valueObject.setJLkod(result.getString("JLKOD"));
                valueObject.setJNama(result.getString("JNAMA"));
                valueObject.setAKtif(result.getString("AKTIF"));
                valueObject.setBAtal(result.getString("BATAL"));

            } else {
                //System.out.println("HVpjln Object Not Found!");
                throw new NotFoundException("HVpjln Object Not Found!");
            }
        } finally {
            if (result != null) {
                result.close();
    ...
    protected List listQuery(Connection conn, PreparedStatement stmt) throws SQLException {
        ...
        try {
            ...
            while (result.next()) {
                ...
                temp.setJLkod(result.getString("JLKOD"));
                temp.setJNama(result.getString("JNAMA"));
                temp.setAKtif(result.getString("AKTIF"));
                temp.setBAtal(result.getString("BATAL"));
